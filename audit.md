> **Исторический документ.** Этот файл описывает первоначальные цели и частично не соответствует фактическому состоянию проекта на 15 июля 2026 года. Актуальные результаты проверки, конкурентное исследование и целевой план находятся в [`docs/README.md`](docs/README.md).
