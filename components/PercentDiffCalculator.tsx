...
const inputClass =
  "w-full px-4 py-3.5 text-base bg-white border-2 border-neutral-300 focus:outline-none focus:border-neutral-900";
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          >
            ...
            <div className="text-xs mt-1">
              На сколько % изменилось от первого числа
            </div>
          </button>
          ...
          >
            ...
            <div className="text-xs mt-1">
              Симметричная разница (без базового значения)
            </div>
          </button>
          ...
          >
            ...
            <div className="text-xs mt-1">
              Насколько одно число больше/меньше другого
            </div>
          </button>
        </div>
      </div>
      ...
      <div className="bg-neutral-50 p-6 space-y-3 border-2 border-neutral-300">
        ...
        <div
          className={`text-5xl font-bold ${result !== null && (result > 0 ? "text-positive" : result < 0 ? "text-negative" : "text-neutral-900")}`}
        >
          {result !== null ? (
            <>
              {result > 0 && "+"}
      ...
      <div className="bg-neutral-50 p-4 border-2 border-neutral-300">
        ...
        <p className="text-sm text-neutral-700 font-mono">
          ...
          {method === "average" &&
            "|Число 1 − Число 2| / ((Число 1 + Число 2) / 2) × 100%"}
